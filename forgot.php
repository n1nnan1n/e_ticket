...
if (isset($_POST['reset-password'])) {
  ...
  $query = "SELECT user_email FROM user_profile WHERE user_email='$email'";
  ...
  if ($errors == "") {
    ...
    $sql = "UPDATE user_profile SET token='$token' WHERE user_email = '$email'";
    $results = mysqli_query($con, $sql);
    
    $subject = "Reset your e-ticket.su-digitech.net password";
    $msg = "Hi, $email click on this <a href=\"eticket.su-digitech.net/new_pass.php?token=" . $token . "\"><p>link</p></a> to reset your password on our site";
