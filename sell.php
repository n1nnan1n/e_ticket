			...
			if(isset($_POST['submit'])){
				...
				if (password_verify($password, $u['user_password'])) {
						...
						mysqli_query($con, $resetqr);
					  	...
					  	sellback($con,$tid,$_SESSION['id'],$event,$point);
					  	header("Location: myticket.php");
					}else{
		...
		<div class="col-sm-8 mt-2 text-center">
			<div class="card-content-detail">
				<div class="card-body" style="box-shadow: 1px 1px 1px #adadad; border-radius: 15px;">
					...
					เงื่อนไข
					<div class="text-left">
						- จะได้รับแต้มก็ต่อเมื่อขายบัตรนี้ได้แล้ว<br>
						- สามารถโอนสิทธิ์บัตรได้ ถ้าหากบัตรนี้ยังไม่ถูกซื้อ<br>
						- ไม่สามารถยกเลิกขอคืนบัตรได้<br>
						- เมื่อถึงวันจัดงานถ้าหากไม่สามารถขายบัตรนี้ได้ สิทธิ์บัตรจะอยู่กับเจ้าของเดิม
					</div>
				</div>
			</div>
		</div>
		<div class="row mt-2">
							...
							<form action="" method="POST">
                                    <div class="form-group">
                                      <button type="button" class="btn btn-buy" data-bs-toggle="modal" data-bs-target="#exampleModal">ขาย</button>
